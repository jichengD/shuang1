#!/bin/bash
#desc : transform user principal data from  core database and create partner interest source data
#date : 2016-11-30
...
partner_invite_table="dfdf"

partner_invite_bak_table="xxx"

#module current principal table
module_current_table="xxxx"

#module term principal table
module_term_table="xxxx"

#core current principal table
core_current_table="xxxx"

#core term principal table
core_term_table="ssxs"

#mysql cmd
mysql_cmd="mysql -h${mysql_host} -u${mysql_user} -P${mysql_port}"
